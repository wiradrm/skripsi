<div class="modal fade bd-example-modal-lg text-left" id="exportModalPembelian" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('pembelian.export')}}" method="GET" enctype="multipart/form-data">
                @csrf
